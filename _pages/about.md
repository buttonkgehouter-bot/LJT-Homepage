...
I am **Junteng Liu**, a first-year Ph.D. candidate in Computer Science at the Hong Kong University of Science and Technology (HKUST), where I am a member of the HKUST NLP Group under the supervision of Professor Junxian He. My research focuses on natural language processing and machine learning. I received my B.Eng. from Shanghai Jiao Tong University (SJTU), graduating in June 2024, where I was also previously advised by Professor Junxian He during my undergraduate studies.
...
- LLM truthfulness and interpretability
- Vision-Language Model (VLM) hallucination and chart understanding
